  ...
  public static void copyFile(String filePathTarget, String filePath) throws IOException {
    ...
    if (file.exists()) {// 如果文件存在
      ...
      if (fileCopyRes.exists()) {
        ...
        // 第一种：下面写法不好，容易阻塞，效率低
        /*
         * int j=0; while((j=bufferedInputSream.read())!=-1){//如果流读取完毕
         * bufferedOutputStream.write(j); System.out.println(j);
         * 
         * }
         */
        // 第二种：
        ...
        while ((i = bufferedInputSream.read(byteItems)) != -1){
          ...
          bufferedOutputStream.write(byteItems, 0, i);// 每次读取1024字节，这些字节都存放这个数组中，
                                                      // 从数组下标0开始读取，读取的长度i
